...
StringPack.create(guage: 'medium', brand: "Martin", model: "SP bronze", price: 7.50, low_e_string_counter: 4, a_string_counter: 4, d_string_counter: 4, g_string_counter: 7, b_string_counter: 4, high_e_string_counter: 4, user_id: 10)
